...
class Model:
    def __init__(self,
        ...
        self.W_1 = tf.Variable(tf.random_normal([22896, 1000]), trainable=is_train)
        self.W_2 = tf.Variable(tf.random_normal([1000, 318]), trainable=is_train)
        ...
        #fc1 = batch_normalization_layer(fc1, 200, is_train)
        fc1 = tf.nn.relu(fc1)
